...
app.route('/peach-payment/checkout')
    .post(async (req, res) => {
        try {
            ...
            // let key = 'OGFjN2E0Yzk3OGM2ODk0MzAxNzhjZmJlMzFhMDEwYjF8RjZKNFNXUEJnSg=='
            const paymentParams = {
                'amount': '2',
                'authentication.entityId': process.env.PEACH_PAYMENT_ENTITY_ID,
                'currency': 'ZAR',
            ...
            const secret = process.env.PEACH_PAYMENT_SECRET_KEY
            // const hashDigest = sha256(request_data);
            ...
            encodedParams.set('authentication.entityId', process.env.PEACH_PAYMENT_ENTITY_ID);
